                  ...
                  <div class="p-6 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                      <div>
                        ...
                        <p class="text-gray-800">
                          {routeInfo.value.startAddress}
                        </p>
                      </div>
                      <div>
                        <p class="text-sm text-gray-500 font-medium">Destino</p>
                        <p class="text-gray-800">
                          {routeInfo.value.endAddress}
                        </p>
                      </div>
                      <div>
                    ...
                    <div class="border-t pt-4">
                      ...
                      {(() => {
                        ...
                        const km = routeInfo.value!.distanceValue / 1000;
                        const tripValue = calculateDriverRate(km);
                        const ahorro_mes_1 = tripValue * dias * viajesIdaVuelta * semanas;
                        ...
                        return (
                          <div>
                            <p>
                              Por 1 pasajero: ${" "}
                              {formatNumber(Math.round(ahorro_mes_1))} al mes
                              [1].
                            </p>
                            <p>
                              Por 2 pasajeros: ${" "}
                              {formatNumber(Math.round(ahorro_mes_2))} al mes
                              [1].
                            </p>
                            <p>
                              Por 3 pasajeros: ${" "}
                              {formatNumber(Math.round(ahorro_mes_3))} al mes
                              [1].
                            </p>
                            <p class="text-sm text-gray-500 mt-1">
                              [1] Valores mensualizados considerando 20 viajes
                              al mes ida y vuelta. Ahorro por viaje 1 pasajero ${" "}
                              {formatNumber(Math.round(tripValue))}
                            </p>
                          </div>
                        );
